...
이 저장소의 문서와 검증 코드는 **[Claude Code](https://claude.com/claude-code)**(Anthropic)의
도움을 받아 작성했습니다. 환경 조사, 스크립트 구현, 벤치마크 실행, 결과 정리를
Claude Code 와 함께 진행했습니다.

문서의 모든 수치는 실제로 측정한 값이며, `scripts/` 를 그대로 돌려 재현할 수 있습니다.
